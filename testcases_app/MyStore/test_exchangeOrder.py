...
class TestClass:
    ...
    @allure.severity(P1)            
    @allure.title("我的-我的服务中心-押货换货：押货换货主路径检查")
    ...
    def test_01(self, uuid):
        ...
        assert_equal(poco("搜索产品名称编号").exists(), True, msg="搜索产品名称编号")
        ...
        poco(nameMatches="^HYH.+\n复制").click([0.9, 0.5])

        poco("返回服务中心首页").click()

    @allure.severity(P2)            
    @allure.title("我的-我的服务中心-押货换货：通过搜索产品名称和编号提交申请检查")
    @pytest.mark.parametrize("uuid", UUIDS)
    ...
    @allure.severity(P2)            
    @allure.title("我的-我的服务中心-押货换货：押货换货后【查看详情】检查")
    @pytest.mark.parametrize("uuid", UUIDS)
    ...
    @allure.severity(P2)            
    @allure.title("我的-我的服务中心-押货换货：押货换货后【返回列表】检查")
    @pytest.mark.parametrize("uuid", UUIDS)
    ...
    @allure.severity(P2)            
    @allure.title("我的-我的服务中心-押货换货：押货换货【查看详情】后【取消换货】检查")
    @pytest.mark.parametrize("uuid", UUIDS)
